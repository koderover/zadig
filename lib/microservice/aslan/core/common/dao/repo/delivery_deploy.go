...
func NewDeliveryDeployColl() *DeliveryDeployColl {
	name := models.DeliveryDeploy{}.TableName()
	return &DeliveryDeployColl{
...
func (c *DeliveryDeployColl) Find(args *DeliveryDeployArgs) ([]*models.DeliveryDeploy, error) {
	if args == nil {
		return nil, errors.New("nil delivery_deploy args")
	}
	resp := make([]*models.DeliveryDeploy, 0)
...
func (c *DeliveryDeployColl) Insert(args *models.DeliveryDeploy) error {
	if args == nil {
		return errors.New("nil delivery_deploy args")
	}
