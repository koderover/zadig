...
func (r *Reaper) AfterExec() error {
	...
	if r.Ctx.UploadEnabled {
		...
		client, err := s3.NewClient(r.Ctx.UploadStorageInfo.Endpoint, r.Ctx.UploadStorageInfo.AK, r.Ctx.UploadStorageInfo.SK, r.Ctx.UploadStorageInfo.Region, r.Ctx.UploadStorageInfo.Insecure, r.Ctx.UploadStorageInfo.Provider)
		if err != nil {
