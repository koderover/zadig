...
type User struct {
	...
	GroupBindings    []GroupBinding   `gorm:"foreignKey:UID;references:UID;constraint:OnDelete:CASCADE;"`
	UserRoleBindings []NewRoleBinding `gorm:"foreignKey:UID;references:UserID;constraint:OnDelete:CASCADE;"`
}
