...
//var publicURLs = []*types.PolicyRule{
//	{
//		Methods:   []string{"GET"},
...
//var systemAdminURLs = []*types.PolicyRule{
//	{
//		Methods:   []string{"PUT"},
//		Endpoints: []string{"api/v1/features/?*"},
//	},
...
//var projectAdminURLs = []*types.PolicyRule{
//	{
//		Methods:   []string{"PUT"},
//		Endpoints: []string{"api/aslan/project/products"},
//	},
...
var adminURLs = append(meta.DefaultExemptionsUrls().SystemAdmin, meta.DefaultExemptionsUrls().ProjectAdmin...)
