...
type Cronjob struct {
	...
	EnvAnalysisArgs *EnvArgs          `json:"env_analysis_args,omitempty"`
	EnvArgs         *EnvArgs          `json:"env_args,omitempty"`
	ReleasePlanArgs *ReleasePlanArgs  `json:"release_plan_args,omitempty"`
	JobType         string            `json:"job_type"`
