...
func ContainerLogStream(ctx context.Context, streamChan chan interface{}, envName, productName, podName, containerName string, production *bool, follow bool, tailLines int64, sinceSeconds *int64, log *zap.SugaredLogger) {
