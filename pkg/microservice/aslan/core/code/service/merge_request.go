...
func CodeHostListPRs(codeHostID int, projectName, namespace, targetBranch string, key string, page, perPage int, fetchAll bool, log *zap.SugaredLogger) ([]*client.PullRequest, error) {
