...
func (*Router) Inject(router *gin.RouterGroup) {
	...
	product := router.Group("products")
	{
		...
		product.PUT("/:name/searching-rules", gin2.StoreProductName, gin2.IsHavePermission([]string{permission.ServiceTemplateEditUUID}, permission.ContextKeyType), gin2.UpdateOperationLogStatus, CreateOrUpdateMatchRules)
		...
		product.PUT("/:name/serviceOrder", gin2.IsHavePermission([]string{permission.ServiceTemplateEditUUID}, permission.ParamType), gin2.UpdateOperationLogStatus, UpdateServiceOrder)
