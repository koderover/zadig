...
func (*Router) Inject(router *gin.RouterGroup) {
	...
	product := router.Group("products")
	{
		...
		product.GET("/:name/match-rules", GetCustomMatchRules)
		product.PUT("/:name/match-rules", gin2.StoreProductName, gin2.IsHavePermission([]string{permission.SuperUserUUID}, permission.ContextKeyType), gin2.UpdateOperationLogStatus, CreateOrUpdateMatchRules)
