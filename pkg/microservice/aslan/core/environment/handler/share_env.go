...
func EnableBaseEnv(c *gin.Context) {
	...
	internalhandler.InsertDetailedOperationLog(c, ctx.UserName, projectKey, setting.OperationSceneEnv, "开启自测模式", "环境", envName, envName, "", types.RequestBodyTypeJSON, ctx.Logger, envName)
