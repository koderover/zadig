...
func (*Router) Inject(router *gin.RouterGroup) {
	...
	environments := router.Group("environments")
	{
		...
		environments.POST("/:productName/helm", gin2.IsHavePermission([]string{permission.TestEnvCreateUUID, permission.ProdEnvCreateUUID}, permission.ContextKeyType), gin2.UpdateOperationLogStatus, CreateHelmProduct)
		environments.PUT("/:productName/multiHelmEnv", gin2.IsHavePermission([]string{permission.TestEnvCreateUUID, permission.ProdEnvCreateUUID}, permission.ContextKeyType), gin2.UpdateOperationLogStatus, UpdateMultiHelmEnv)
		...
		environments.PUT("/:productName/renderset", gin2.IsHavePermission([]string{permission.TestEnvManageUUID}, permission.ParamType), gin2.UpdateOperationLogStatus, UpdateHelmProductRenderset)
