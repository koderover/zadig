...
type ReleasePlan struct {
	...
	WaitForSuccessExternalCheckTime int64 `bson:"wait_for_success_external_check_time"       yaml:"wait_for_success_external_check_time"                   json:"wait_for_success_external_check_time"`
}
