...
type ServiceTestTarget struct {
	...
	Repos []*types.Repository `bson:"repos,omitempty" yaml:"repos,omitempty" json:"repos,omitempty"`
}
...
type AIReleaseSpecialistJobSpec struct {
	...
	SystemPrompt         string  `bson:"-" json:"system_prompt,omitempty" yaml:"system_prompt,omitempty"`
}
