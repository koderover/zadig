...
type TerminalSession struct {
	// Common session and operator fields.
	...
	// Kubernetes target fields used by PodExec and WorkflowDebug sessions.
	...
	// Recording lifecycle and storage fields.
