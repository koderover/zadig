...
type Product struct {
	...
	CustomImageRule            *CustomImageRule `bson:"custom_image_rule,omitempty"         json:"custom_image_rule,omitempty"`
	CustomTarRule              *CustomTarRule   `bson:"custom_tar_rule,omitempty"           json:"custom_tar_rule,omitempty"`
}
