...
type WorkflowV4GeneralHookColl struct {
	*mongo.Collection

	coll string
}

func NewWorkflowV4GeneralHookColl() *WorkflowV4GeneralHookColl {
	name := models.WorkflowV4GeneralHook{}.TableName()
	return &WorkflowV4GeneralHookColl{
		Collection: mongotool.Database(config.MongoDatabase()).Collection(name),
		coll:       name,
	}
}

func (c *WorkflowV4GeneralHookColl) GetCollectionName() string {
	return c.coll
}

func (c *WorkflowV4GeneralHookColl) EnsureIndex(ctx context.Context) error {
...
func (c *WorkflowV4GeneralHookColl) Create(ctx *internalhandler.Context, obj *models.WorkflowV4GeneralHook) (string, error) {
	if obj == nil {
...
func (c *WorkflowV4GeneralHookColl) List(ctx *internalhandler.Context, workflowName string) ([]*models.WorkflowV4GeneralHook, error) {
	filter := bson.M{}
	if workflowName != "" {
	...
	var hooks []*models.WorkflowV4GeneralHook
...
func (c *WorkflowV4GeneralHookColl) Get(ctx *internalhandler.Context, workflowName, hookName string) (*models.WorkflowV4GeneralHook, error) {
	var hook *models.WorkflowV4GeneralHook
...
func (c *WorkflowV4GeneralHookColl) Delete(ctx *internalhandler.Context, id string) error {
	oid, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return err
	}
