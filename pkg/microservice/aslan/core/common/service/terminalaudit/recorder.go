...
func newRecorder(meta *SessionMeta) (*asciicastRecorder, error) {
	...
	session := &models.TerminalSession{
		...
		TerminalSessionWorkflowContext: models.TerminalSessionWorkflowContext{
			WorkflowName: meta.WorkflowName,
			JobName:      meta.JobName,
			TaskID:       meta.TaskID,
		},
		TerminalSessionTarget: models.TerminalSessionTarget{
			TargetName: meta.TargetName,
			Protocol:   meta.Protocol,
			RemoteAddr: meta.RemoteAddr,
		},
		TerminalSessionSSHTarget: models.TerminalSessionSSHTarget{
			LoginAccount: meta.LoginAccount,
			HostID:       meta.HostID,
			HostName:     meta.HostName,
			HostIP:       meta.HostIP,
		},
		TerminalSessionKubernetesTarget: models.TerminalSessionKubernetesTarget{
		...
		TerminalSessionRecording: models.TerminalSessionRecording{
