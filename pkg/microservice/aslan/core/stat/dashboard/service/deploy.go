...
import (
	...
	models "github.com/koderover/zadig/pkg/microservice/aslan/core/stat/dashboard/repository/models"
...
type dashboardDeploy struct {
	...
	DashboardDeployDailys []*dashboardDeployDaily `json:"data,omitempty"`
}
