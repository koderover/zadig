...
func CancelWorkflowTaskV4(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, username, projectKey, "取消", "工作流任务", c.Param("workflowName"), c.Param("workflowName"), "", types.RequestBodyTypeJSON, ctx.Logger)
...
func RetryWorkflowTaskV4(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, projectKey, "重试", "工作流任务", c.Param("workflowName"), c.Param("workflowName"), "", types.RequestBodyTypeJSON, ctx.Logger)
...
func ManualExecWorkflowTaskV4(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, projectKey, "手动执行", "工作流任务", c.Param("workflowName"), c.Param("workflowName"), string(data), types.RequestBodyTypeJSON, ctx.Logger)
...
func RevertWorkflowTaskV4Job(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, w.Project, "回滚", "工作流任务", w.Name, w.Name, data, types.RequestBodyTypeJSON, ctx.Logger)
...
func UpdateWorkflowV4TaskRemark(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, w.Project, "更新", "工作流任务", workflowName, workflowName, data, types.RequestBodyTypeJSON, ctx.Logger)
