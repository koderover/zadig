...
func CreateCustomWorkflowTask(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, args.ProjectName, "新建", "工作流任务", args.WorkflowName, data, types.RequestBodyTypeJSON, ctx.Logger)
...
func OpenAPIDeleteCustomWorkflowV4(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, projectKey, "(OpenAPI)"+"删除", "工作流", workflowKey, "", types.RequestBodyTypeJSON, ctx.Logger)
...
func OpenAPIRetryCustomWorkflowTaskV4(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, c.Query("projectKey"), "OpenAPI"+"重试", "工作流任务", name, fmt.Sprintf("%d", taskID), types.RequestBodyTypeJSON, ctx.Logger)
...
func OpenAPIUpdateWorkflowV4TaskRemark(c *gin.Context) {
	...
	internalhandler.InsertOperationLog(c, ctx.UserName, w.Project, "OpenAPI"+"更新", "工作流任务", workflowName, data, types.RequestBodyTypeJSON, ctx.Logger)
