...
func (*Router) Inject(router *gin.RouterGroup) {
	...
	workflowV4 := router.Group("v4")
	{
		...
		workflowV4.GET("/templates/:templateID/versions", ListWorkflowTemplateVersions)
		workflowV4.GET("/templates/:templateID/diff", DiffWorkflowTemplateVersions)
		workflowV4.GET("/:name/template-binding/status", GetWorkflowTemplateBindingStatus)
		workflowV4.POST("/:name/template-binding/preview", PreviewWorkflowTemplateBinding)
		workflowV4.POST("/:name/template-binding/resolve", ResolveWorkflowTemplateBinding)
		workflowV4.POST("/:name/template-binding/unbind", UnbindWorkflowTemplateBinding)
