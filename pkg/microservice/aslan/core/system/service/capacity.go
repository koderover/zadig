...
func CleanCache() error {
	...
	client, err := s3tool.NewClient(s3Server.Endpoint, s3Server.Ak, s3Server.Sk, s3Server.Insecure, s3Server.Provider)
	if err != nil {
...
func cleanStaleTasks(tasks []*task.Task, s3Server *s3.S3, dryRun bool) []string {
	...
	s3client, err := s3tool.NewClient(s3Server.Endpoint, s3Server.Ak, s3Server.Sk, s3Server.Insecure, s3Server.Provider)
	if err == nil {
