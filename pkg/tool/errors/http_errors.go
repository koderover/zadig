...
var (
	...
	// ErrCreateDeployModule ...
	ErrCreateDeployModule = NewHTTPError(6520, "新建部署模块失败")
	// ErrUpdateDeployModule ...
	ErrUpdateDeployModule = NewHTTPError(6521, "更新部署模块失败")
	// ErrListDeployModule ...
	ErrListDeployModule = NewHTTPError(6522, "列出部署模块失败")
	// ErrGetDeployModule ...
	ErrGetDeployModule = NewHTTPError(6523, "查询编译模块失败")
	// ErrDeleteBuildModule ...
	ErrDeleteDeployModule = NewHTTPError(6524, "删除构建模块失败")
