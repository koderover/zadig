...
var (
	...
	//-----------------------------------------------------------------------------------------------
	ErrCreateZadigHost  = NewHTTPError(7030, "创建 zadig vm 失败")
	ErrListZadigHost    = NewHTTPError(7031, "获取 zadig vm 列表失败")
	ErrUpdateZadigHost  = NewHTTPError(7032, "更新 zadig vm 失败")
	ErrDeleteZadigHost  = NewHTTPError(7033, "删除 zadig vm 失败")
	ErrOfflineZadigHost = NewHTTPError(7034, "下线 zadig vm 失败")
	ErrUpgradeZadigHost = NewHTTPError(7035, "升级 zadig agent 失败")
)
